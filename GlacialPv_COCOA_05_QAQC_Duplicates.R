...
RPostgreSQL::dbSendQuery(con, "ALTER TABLE surv_pv_gla.geo_detections 
                         ADD COLUMN IF NOT EXISTS qaqc_duplicate CHARACTER VARYING(25)")
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_detections 
                         SET qaqc_duplicate = \'to_evaluate\'")

RPostgreSQL::dbSendQuery(con, "ALTER TABLE surv_pv_gla.tbl_detections_processed_rgb 
                         ADD COLUMN IF NOT EXISTS qaqc_duplicate CHARACTER VARYING(25)")
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.tbl_detections_processed_rgb 
                         SET qaqc_duplicate = \'to_evaluate\'")

# Mark "suppressed" detections as such in qaqc_duplicate field in tbl_detections_processed_rgb and geo_detections
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_detections
                         SET qaqc_duplicate = \'suppressed\' 
...
#### Ideally from qaqc_cocoa_xcamera_duplicates query
