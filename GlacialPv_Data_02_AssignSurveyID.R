...
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'excelsior_20240825_targetedcount_1'\ WHERE flight = \'fl14\' AND dt >= \'20240825_222500\' AND dt <= \'20240825_222659\' AND effort = \'ON\'") 

RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'mccarty_20240826_targetedcount_1'\ WHERE flight = \'fl15\' AND dt >= \'20240826_201600\' AND dt <= \'20240826_201759\' AND effort = \'ON\'") 
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'northwestern_20240826_fullcount_1'\ WHERE flight = \'fl15\' AND dt >= \'20240826_202800\' AND dt <= \'20240826_203030\' AND effort = \'ON\'")
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'northwestern_20240826_fullcount_2'\ WHERE flight = \'fl15\' AND dt >= \'20240826_203031\' AND dt <= \'20240826_203259\' AND effort = \'ON\'") 
...
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'tiger_20240826_fullcount_1'\ WHERE flight = \'fl15\' AND dt >= \'20240826_213800\' AND dt <= \'20240826_214059\' AND effort = \'ON\'") 
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'tiger_20240826_fullcount_2'\ WHERE flight = \'fl15\' AND dt >= \'20240826_214100\' AND dt <= \'20240826_214359\' AND effort = \'ON\'") 
