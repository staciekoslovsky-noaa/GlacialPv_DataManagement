...
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'chenega_20200911_targetedmosaic_a_1\' WHERE evt_header_frame_id = \'ins_evt\' AND flight = \'fl11\' AND dt >= \'20200911_215100\' AND dt <= \'20200911_215359\'") 
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'chenega_20200911_targetedmosaic_a_2\' WHERE evt_header_frame_id = \'ins_evt\' AND flight = \'fl11\' AND dt >= \'20200911_215500\' AND dt <= \'20200911_215759\'") 
RPostgreSQL::dbSendQuery(con, "UPDATE surv_pv_gla.geo_images_meta SET survey_id = \'chenega_20200911_targetedmosaic_b_1\' WHERE evt_header_frame_id = \'ins_evt\' AND flight = \'fl11\' AND dt >= \'20200911_215900\' AND dt <= \'20200911_220259\'") 
